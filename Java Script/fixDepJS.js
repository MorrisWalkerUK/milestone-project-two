...
function validAcc () {
    ...
    {
        document.getElementById( "result" ).innerHTML = "Account No. must be 16 numeric characters";
        wrong();
...
function validCard () {
    ...
    {
        document.getElementById( "result" ).innerHTML = "Card No. must be 16 numeric characters";
        wrong();
